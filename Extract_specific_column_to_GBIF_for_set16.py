...
#os.chdir('G:/Cristian data/Humboldt/Scripts/Python/extract_specific_column_to_GBIF_for_set16.py') ##folder for the code

#Set16 Folder
os.chdir('D:/Set16/datos_originales/GBIF&SiB/raw/Descarga_2022_01_13_directGBIF/0112920-210914110416597/')
...
#export
df.to_csv('filteredOcc2.1.txt', header=True, index=None, sep=';', encoding='utf-8')
